...
class NIDUploadForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "nid_card_front": forms.ClearableFileInput(
                attrs={
                    "class": "form-control",
            ...
            "nid_card_back": forms.ClearableFileInput(
                attrs={
                    "class": "form-control",
                    "accept": ".pdf,.jpg,.jpeg,.png",
                    "multiple": False,
...
class FarmerProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "land_documents": forms.ClearableFileInput(
        ...
        if loan_type and amount:
            if amount > loan_type.max_amount:
                raise forms.ValidationError(
                    f"Amount exceeds maximum limit of ৳{loan_type.max_amount}"
                )
        return cleaned_data
